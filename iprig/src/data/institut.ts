...
export const institut = {
  eyebrow: "L’institut",
  title: "Une préparation, pas une bibliothèque de vidéos",
  ...
  body: [
    "L’accompagnement repose sur des séances régulières, un suivi des questions de chacun et des opportunités transmises aux membres tout au long de l’année. L’objectif n’est pas d’accumuler des heures de contenu, mais de donner des méthodes de travail, des repères sur le milieu et un cadre pour avancer.",
    "L’institut s’adresse d’abord aux étudiants de licence et de master en relations internationales, en science politique et en géopolitique, ainsi qu’à celles et ceux qui souhaitent s’orienter vers ces secteurs. Les lycéens qui réfléchissent à leurs études et les personnes engagées dans une reconversion y trouvent également leur place.",
  ],
};

/** À qui s’adresse l’institut — affiché en encart. */
export const publics: string[] = [
  'Étudiants en licence et en master',
  'Relations internationales, science politique, géopolitique',
  "Futurs candidats à une orientation dans ces secteurs",
  'Lycéens qui construisent leur projet d’études',
];

/* -------------------------------------------------------------------------- */
/*  LES APPORTS DE L’INSTITUT                                                 */
/* -------------------------------------------------------------------------- */
 ...
 * Ajouter ou retirer une entrée n’a aucun effet sur la mise en page.
 */
export const apports: Apport[] = [
  {
    index: '01',
    title: 'Un réseau',
    text: "Les membres construisent progressivement leur réseau dans les milieux liés aux relations internationales et à la géopolitique, au fil des séances et des rencontres.",
  },
  {
    index: '02',
  ...
  },
  {
    index: '03',
    title: 'Une immersion',
    text: "Comprendre de l’intérieur le milieu académique et professionnel que l’on vise change la façon de construire ses études et ses candidatures.",
  },
  {
    index: '04',
